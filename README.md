...
3.	Add a variable titled stateVerify as a strin-
...
7.	Select the Class attribute and paste in the following text: _com.activit-extension.bean.KYCJavaDelegate_
