...
6. Select the **Template** attribute to open the template popup window:
   - Select the **Custom Template** tab and use the _Choose File_ button to navigate to the ```9si_newCustomer.docx``` file provided to you at: [9si_newCustomer.docx](https://github.com/GBHyland/APS-Process-Workflow-intermediate/blob/main/Class%20Documents%20for%20Attendees/9si_newCustomer.docx). 
